...
import { updateBEAppointment, updateFEAppointment, deleteBEAppointment, deleteFEAppointment, createAppointment } from '../FetchData/appointmentSlice'
...
const PortalCalendar = ({ docAppointments, user, patientAppts, patients, patientNames }) => {
    ...
    const [currentDate, setCurrentDate ] = useState('2023-01-18')
